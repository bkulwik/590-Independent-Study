...
End */
			...
			U_star_l.rhoE = (p_guess_temp[1]/(gamma-1)-(pow(U_star_l.rhou,2)/(U_star_l.rho*2))); 
			...
			U_star_r.rhoE = (p_guess_temp[1]/(gamma-1)-(pow(U_star_r.rhou,2)/(U_star_r.rho*2))); 
